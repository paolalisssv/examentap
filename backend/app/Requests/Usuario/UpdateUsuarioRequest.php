...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'password', type: 'string', format: 'password', nullable: true, example: 'NuevoSecret123!'),
    ...
    public function rules(): array
    {
        return [
            ...
            'email' => [
                ...
                'email',
                new FirestoreUnique(
                    fn (string $email) => app(UsuarioRepositoryInterface::class)->findByEmail($email),
                    $this->route('usuario')
                ),
            ],
