...
class StorePerfilRequest extends BaseFormRequest
{
    public function rules(): array
    {
        return [
            'name' => [
                ...
                'string',
                'max:255',
                new FirestoreUnique(fn (string $name) => app(PerfilRepositoryInterface::class)->findByNombre($name)),
            ],
